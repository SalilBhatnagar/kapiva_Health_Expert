...
export default class Cart extends PageManager {
    ...
    cartUpdate($target) {
        ...
        if (newQty == 0) {
            const name = $("input[data-cart-itemid='" + itemId + "']").attr("aria-label");
            window.dataLayer = window.dataLayer || [];
            window.dataLayer.push({
       ...
       if(oldQty>newQty||newQty == 0) {  const name = document.querySelector("input[data-cart-itemid='" + itemId + "']").getAttribute("aria-label");

          const product_sku = document.querySelector("input[data-cart-itemid='" + itemId + "']").getAttribute("data-product-sku");
          const product_price = document.querySelector("input[data-cart-itemid='" + itemId + "']").getAttribute("data-product-price");
          const product_quantity =  document.querySelector("input[data-cart-itemid='" + itemId + "']").getAttribute("value");
          ...
          else if(oldQty<newQty) {  const name = document.querySelector("input[data-cart-itemid='" + itemId + "']").getAttribute("aria-label");
    ...
    cartRemoveItem(itemId) {
        ...
        const name = document.querySelector("input[data-cart-itemid='" + itemId + "']").getAttribute("aria-label");
